...
% reversing sign on stress feild to allign with engineering covention
permeability_ratio = ((exp(alpha*-sigma_feild) + Rb)./(exp(alpha*-sigma_feild(:,:,1)) + Rb)).^3; 

% permeability ratio > 1 implies increase in permeability
% permeability ratio < 1 implies decrease in permeability
